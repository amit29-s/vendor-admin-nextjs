...
const tableData = [
    ...
    },
    {
        id: 3,
        name: 'Alma Clarke',
        role: 'Merchandiser Additional Custom',
...
const UsersTable = () => {
    ...
    return (
        <div className="grid grid-cols-1 gap-6 xl:grid-cols-1 h-[75vh]">
                            ...
                            {tableData.map((data) => {
                                return (
                                    <tr key={data.id}>
                                        ...
                                        <td className='cursor-pointer' onClick={handleFeature}>
                                            <div className="whitespace-nowrap">{data.name}</div>
                                        </td>
                                        <td className='cursor-pointer' onClick={handleFeature}>{data.role}</td>
                                        <td className='cursor-pointer' onClick={handleFeature}>{data.date}</td>
